...
public final class DatasetPolicyRegistry {
    ...
    private static Map<String, DatasetOperationalPolicy> buildPolicies() {
        ...
        // Phase 1 — 안전·환경 신규
        add(policies, policy("playgrounds", "name+address", 1, 2000, Duration.ofDays(365), Duration.ofDays(1825), true, LOW));
        add(policies, policy("aed-devices", "name+address", 1, 2000, Duration.ofDays(365), Duration.ofDays(1825), true, LOW));
