...
class DatasetRegistryTest {
    ...
    @Test
    void aedDeviceIsSafetyApiWithCoords() {
        var def = registry.getRequired("aed-devices");
        assertThat(def.datasetName()).isEqualTo("자동제세동기(AED)");
        assertThat(def.domain()).isEqualTo("안전");
        assertThat(def.authKeyRequired()).isTrue();
        assertThat(def.spatialType()).isEqualTo("POINT");
        assertThat(def.requiredFields()).contains("latitude", "longitude");
    ...
    @Test
    void streetLightIsSafetyStandardDataWithCoords() {
        var def = registry.getRequired("street-lights");
        assertThat(def.datasetName()).isEqualTo("보안등");
        assertThat(def.domain()).isEqualTo("안전");
        assertThat(def.authKeyRequired()).isTrue();
        assertThat(def.spatialType()).isEqualTo("POINT");
        assertThat(def.requiredFields()).contains("latitude", "longitude");
    ...
    @Test
    void fireHydrantIsSafetyStandardDataWithCoords() {
        var def = registry.getRequired("fire-hydrants");
        assertThat(def.datasetName()).isEqualTo("소방용수시설");
        assertThat(def.domain()).isEqualTo("안전");
        assertThat(def.authKeyRequired()).isTrue();
    ...
    @Test
    void libraryIsLifestyleStandardDataWithCoords() {
        var def = registry.getRequired("libraries");
        assertThat(def.datasetName()).isEqualTo("도서관");
        assertThat(def.domain()).isEqualTo("생활");
        assertThat(def.authKeyRequired()).isTrue();
        assertThat(def.envVarName()).isEqualTo("DATA_GO_KR_API_KEY");
        assertThat(def.spatialType()).isEqualTo("POINT");
        assertThat(def.publicVisible()).isTrue();
    ...
    @Test
    void parkIsLifestyleStandardDataWithCoords() {
        var def = registry.getRequired("parks");
        assertThat(def.datasetName()).isEqualTo("도시공원");
        assertThat(def.domain()).isEqualTo("생활");
        assertThat(def.authKeyRequired()).isTrue();
        assertThat(def.envVarName()).isEqualTo("DATA_GO_KR_API_KEY");
        assertThat(def.spatialType()).isEqualTo("POINT");
