-- 도시공원 데이터셋을 카탈로그에 등록한다 (Phase 1 배치 1-C)
-- 수집원: 공공데이터포털 전국도시공원정보표준데이터 (15012890, 자동승인)
-- 좌표: 응답에 LATITUDE/LONGITUDE 직접 포함 — VWorld 지오코딩 불필요
-- Flyway 정본: backend-egovframe-skeleton/src/main/resources/db/migration/V10__parks.sql
