-- 보안등 데이터셋을 카탈로그에 등록한다 (Phase 1 배치 1-D)
-- 수집원: 공공데이터포털 전국보안등정보표준데이터 (tn_pubr_public_scrty_lmp_api)
-- 전국 약 184만 건 — insttNm/rdnmadr 기준 금천구 필터 후 저장
-- Flyway 정본: backend-egovframe-skeleton/src/main/resources/db/migration/V14__street_lights.sql
...
VALUES (
    'street-lights', '보안등', '안전',
    '공공데이터포털 전국보안등정보표준데이터',
